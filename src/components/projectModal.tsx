...
const ProjectModal: React.FC<ProjectModalProps> = ({ project, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white p-4 sm:p-5 rounded-lg shadow-2xl flex flex-col w-full max-w-sm sm:max-w-s md:max-w-md lg:max-w-lg xl:max-w-2xl max-h-[100vh] relative overflow-auto animate-fadeIn">
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col items-center p-2 sm:p-4">
          <div className="flex items-center justify-between w-full mb-2 sm:mb-4">
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#001b5e]">
                {project.title}
              </h2>
